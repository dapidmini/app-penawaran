...
--}}
<div class="modal fade penawaran-data-barang" id="modalPilihCustomer" tabindex="-1" aria-labelledby="modalPilihCustomerLabel" aria-hidden="true">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                data-bs-target="#groupDaftarCust" aria-expanded="true" aria-controls="groupDaftarCust">
                                Daftar Barang
                            </button>
                        </h2>
                        <div id="groupDaftarCust" class="accordion-collapse collapse show"
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="fit">Telepon</th>
